...
for i in range(1,1000):
  ...
  target.to_csv("pop_split_msprime/target_1_replicate_%s_dt_%s_recomb_%s.csv" % (i,divergence_time,recombination_rate) , index = False)
  #Write out the files
  for j in range(1,peripheral_pops):
    ...
    gwas.to_csv("pop_split_msprime/peripheral_%s_replicate_%s_dt_%s_recomb_%s.csv" % (j,i,divergence_time,recombination_rate), index = False)
