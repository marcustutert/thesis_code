...
#Reshape the data
results = ref_ld_imputed_sumstats_by_ref_ld_results
colnames(results)[1:4] = divergence_time
##Reshape the data table
reshaped_results <- melt(data = results, variable.name = "divergence_time")
...
colnames(ref_ld_imputed_sumstats_by_ref_ld_results)[1:4] = divergence_time
##Reshape the data table
reshaped_results <- melt(data = ref_ld_imputed_sumstats_by_ref_ld_results, variable.name = "divergence_time")
x = reshaped_results[complete.cases(reshaped_results), ]
