...
#Read in GWAS table
positions       = as.vector(read.table(sprintf("msprime_data/joint_filtered/positions_region_%s", regions)))
ncausal_snps    = 3
...
homo_risk_1     = 1.5^2 #Change this
hetero_risk_2   = 1.5 #Change this
homo_risk_2     = 1.5^2 #Change this
hetero_risk_3   = 1.5 #Change this
homo_risk_3     = 1.5^2 #Change this
